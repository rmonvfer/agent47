...
internal val builtinSlashCommands: List<SlashCommandSpec> = listOf(
    ...
    SlashCommandSpec("/tree", "Navigate the session tree"),
    SlashCommandSpec("/fork", "Fork a new session from a past message"),
    SlashCommandSpec("/clone", "Clone the current session into a new file"),
    SlashCommandSpec("/resume", "Resume a saved session"),
